...
$root = __DIR__ . '/vendor/fluidtypo3/';
$extensions = array(
	'Flux' => 'flux',
	'Vhs' => 'vhs',
	'Builder' => 'builder',
	...
	'FluidcontentCore' => 'fluidcontent_core',
	'Fluidbackend' => 'fluidbackend',
	'Schemaker' => 'schemaker',
	'Flll' => 'flll'
);
$autoloader = require __DIR__ . '/vendor/autoload.php';
foreach ($extensions as $namespace => $extensionKey) {
	$autoloader->addPsr4('FluidTYPO3\\' . $namespace . '\\Tests\\Fixtures\\', $root . $extensionKey . '/Tests/Fixtures/');
	$autoloader->addPsr4('FluidTYPO3\\' . $namespace . '\\Tests\\Unit\\', $root . $extensionKey . '/Tests/Unit/');
}
